...
# Add any paths that contain custom statistics files (such as style sheets) here,
# relative to this directory. They are copied after the builtin statistics files,
# so a file named "default.css" will overwrite the builtin "default.css".
html_statistics_path = ['_statistics']
